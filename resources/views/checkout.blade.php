...
<head>
    ...
    <title>Checkout - FashionStore Bootstrap Template</title>
                        ...
                        <div class="checkout-forms" data-aos="fade-up" data-aos-delay="150">
                            ...
                            <div class="checkout-form active" data-form="1">
                                ...
                                <form class="checkout-form-element">
                                    ...
                                    <div class="text-end mt-4">
                                        <button type="button" class="btn btn-primary next-step" data-next="2">Continue
                                            to Shipping</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="checkout-form" data-form="2">
                                ...
                                <form class="checkout-form-element">
                                    ...
                                    <div class="d-flex justify-content-between mt-4">
                                        ...
                                        <button type="button" class="btn btn-primary next-step" data-next="3">Continue
                                            to Payment</button>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="payment-methods">
                                        ...
                                        <div class="payment-method mt-3">
                                            ...
                                            <div class="payment-method-body d-none">
                                                <p>You will be redirected to PayPal to complete your purchase securely.
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="checkout-form" data-form="4">
                                ...
                                <form class="checkout-form-element">
                                    ...
                                    <div class="success-message d-none">Your order has been placed successfully! Thank
