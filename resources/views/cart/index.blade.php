                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    <div class="cart-items">
                        ...
                        <div class="cart-item" id="cart-item">
                            <div class="cart-ireng row align-items-center">
                                ...
                                <div class="col-lg-2 col-12 mt-3 mt-lg-0 text-center">
                                    <div class="price-tag">
                                        <span
                                            class="current-price">Rp{{ number_format($item->variant->harga ?? 0) }}</span>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12 mt-3 mt-lg-0 text-center">
                                    <div class="quantity-selector">
                                        <button class="quantity-btn decrease" data-id="{{ $item->id }}"
                                            data-stock="{{ $item->variant->stok->jumlah }}">
                                            <i class="bi bi-dash"></i>
                                        </button>
                                        <input disabled type="number" class="quantity-input" value="{{ $item->qty }}"
                                            min="1" max="{{ $item->variant->stok->jumlah }}">
