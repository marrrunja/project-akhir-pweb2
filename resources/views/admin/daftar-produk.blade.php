        ...
        <div class="row">
            <div class="col-12 col-md-10 col-xl-5">
                <div class="input-group mb-3 mt-2">
                  <input type="text" name="keyword" class="form-control border-primary border-2" placeholder="Cari nama produk atau kategori...." aria-label="Cari nama produk atau kategori...." aria-describedby="button-addon2" id="inputCari">
                  <button class="btn btn-primary border-primary border-2" type="button" id="button-addon2">Button</button>
                </div>
            </div>
        </div>
        <div class="row">
