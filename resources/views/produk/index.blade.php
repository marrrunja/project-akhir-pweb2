...
@section('title', 'Blog - FashionStore Bootstrap Template')
      ...
      <div class="col-md-6 col-lg-3 product-item isotope-item filter-clothing">
        <div class="product-card">
          <div class="product-image">
            ...
            <img src="{{ asset('assets/img/product/product-1-variant.webp') }}" alt="Product Hover" class="img-fluid hover-img">
          ...
          <div class="product-info">
            <h5 class="product-title"><a href="/produk/variant/{{ $product->id }}">{{ $product->nama }}</a></h5>
