            ...
            <div class="card product-card h-100">
                ...
                <div class="card-body text-center">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>{{ $variant->variant }} - Rp{{ number_format($variant->harga ?? 0, 0, ',', '.') }} - Stok:
                            {{ $variant->stok ? $variant->stok->count() : 0 }}</li>
                        @endforeach
                    </ul>
                    <button style="background-color: #A23C33;" class="btn btn-primary add-to-cart-btn w-100"
                        data-bs-toggle="modal" data-bs-target="#addToCartModal{{$produk->id}}">Add to Cart <i
                            class="bi bi-cart4 ms-2"></i></button>
                </div>
            </div>
        </div>
